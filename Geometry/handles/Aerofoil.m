classdef Aerofoil < handle
    ...
    methods
        ...
        function obj = redist(obj, x)
            ...
            % zl has to be defined last due to post-set listener
        ...
        function [obj, min_t] = check_thickness(obj)
    ...
    methods (Static)
        ...
        function a = violation(id)
            ...
            val_min = [0, 0.15, nan, 0.1, 0, nan, 0.15, 0.05, 0, 0.005, 0.005];
            val_max = [nan, 0.65, 0, 0.65, nan, 0, 0.65, 0.15, nan, nan, nan];
            fun = [];
            norm = [0.5, nan, -0.5, nan, nan, -0.5, nan, nan, 0.01, 0.05, 0.05];
            name = ["du_f", "cuMax", "dl_f", "clMin", "dt_f", "dt_r", "ctMax", "tMax", "tMin", "rle", "rle"];
            
            if nargin < 1 || isempty(id), id = 1:numel(val_min); end
            
            a = Violation(val_min(id), val_max(id), fun, norm(id), name(id));
        end
